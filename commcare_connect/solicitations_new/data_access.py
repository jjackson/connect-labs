"""
Data Access Layer for solicitations_new.
...
Type constants:
- Solicitations: experiment=program_id, type="solicitation_new"
- Responses: experiment=llo_entity_id, type="solicitation_new_response"
...
RESPONSE_TYPE = "solicitation_new_response"
REVIEW_TYPE = "solicitation_new_review"


class SolicitationsNewDataAccess:
    """
    Data access layer for solicitations_new that uses LabsRecordAPIClient.
    ...
    def __init__(
        ...
        """Initialize solicitations_new data access.
        ...
        if not access_token:
            raise ValueError("OAuth access token required for solicitations_new data access")
